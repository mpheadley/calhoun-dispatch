...
- **Cost basis (Fourthwall POD):** ~$8
- **Sale price:** $18
- **Margin:** $10

## Design Direction

**Wrap design (single side, repeated or centered facing handle-right):**
...
Color: black ink on white ceramic. Single color keeps cost low and reads as period-correct (1998 office mugs were almost always two-color or one-color).

Optional second-side detail (handle-left side, small):
